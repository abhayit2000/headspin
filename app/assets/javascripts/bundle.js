...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({
	  ...
	  addHover: function addHover(list) {
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      { className: "app" },
	      React.createElement(Selections, { addHover: this.addHover, removeHover: this.removeHover }),
	      React.createElement(Downloads, { hover: this.state.hover })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Downloads = React.createClass({
	  ...
	  deleteTag: function deleteTag(tag, download) {
	    AppActions.deleteTag(tag, download);
	  },
	  addTag: function addTag(tag, download) {
	    AppActions.createTag(tag, download);
	  },
	  highlighted: function highlighted(download) {
	    var bool = false;
	    this.props.hover.forEach(function (match) {
	  ...
	  render: function render() {
	    ...
	    if (this.state.downloads.length > 0) {
	      this.state.downloads.forEach(function (download) {
	        if (_this.highlighted(download)) {
	          // debugger
	          classes = "download highlighted";
	        } else {
	          classes = "download";
	        }
	        var speed = (download.size / download.time).toFixed(2);
	        var string = download.size + "MB in " + download.time + " seconds. (" + speed + "MB/s)";
	        downloads.push(React.createElement(
	          "div",
	          ...
	          React.createElement(Tags, { deleteTag: _this.deleteTag,
	            addTag: _this.addTag,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  createTag: function createTag(tag, download) {
	    Dispatcher.dispatch({
	  ...
	  createSelection: function createSelection(tags) {
	    Dispatcher.dispatch({
	      actionType: "CREATE_SELECTION",
	      tags: tags
	    });
	  },
	  deleteSelection: function deleteSelection(id) {
	    Dispatcher.dispatch({
	...
	var Tags = React.createClass({
	  ...
	  render: function render() {
	    ...
	    this.props.tags.forEach(function (tag) {
	      var string = tag.name + " = " + tag.value;
	      tags.push(React.createElement(
	        "span",
	        { className: "tag", key: i },
	        string,
	        React.createElement("img", { onClick: function onClick() {
	            return _this.props.deleteTag(tag, _this.props.download);
	          },
	    ...
	    return React.createElement(
	      ...
	      { className: "tags" },
	      tags,
	      this.state.displayInput ? React.createElement(NewTag, {
	        hideDisplay: this.displayInput,
	        download: this.props.download,
	        addTag: this.props.addTag }) : null,
	      React.createElement("img", { onClick: this.displayInput,
	        className: "add-tag",
	...
	var NewTag = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      "span",
	      { className: "drop-down" },
	      React.createElement("input", { onChange: this.nameChange, className: "input",
	        type: "text", placeholder: "tag type" }),
	      React.createElement("input", { onChange: this.valueChange, className: "input",
	        type: "text", placeholder: "tag name" }),
	      React.createElement(
	        "span",
	        { onClick: this.handleClick, className: "add-button" },
	        "add"
	      )
	    );
	  }
	...
	var Selections = React.createClass({
	  ...
	  render: function render() {
	    ...
	    if (this.state.selections && this.state.selections.length > 0) {
	      this.state.selections.forEach(function (selection) {
	        var tags = selection.queryTags.map(function (tag) {
	          return React.createElement(
	            "span",
	            { className: "tag",
	              key: tag.name },
	        ...
	        if (selection.length === 0) {
	          selections.push(React.createElement(
	            "div",
	            { className: "empty selection" },
	            "No Sessions Found.",
	            React.createElement(
	              "div",
	              { className: "selection-tags" },
	              tags
	            ),
	            React.createElement("img", { onClick: function onClick() {
	                return _this.deleteSelection(selection.id);
	              },
	          ...
	          selections.push(React.createElement(
	            "div",
	            { className: "selection",
	              onMouseOut: _this.props.removeHover,
	              onMouseOver: function onMouseOver() {
	                return _this.props.addHover(selection.list);
	              }, key: i },
	            React.createElement(
	              "div",
	              { className: "averages" },
	              ...
	              React.createElement(
	                "div",
	                { className: "data" },
	                selection.averageData,
	                " MB (average data)"
	              ),
	              React.createElement(
	                "div",
	                { className: "time" },
	                selection.averageTime,
	                " seconds (average time)"
	              ),
	              React.createElement(
	                "div",
	                { className: "speed" },
	                selection.averageSpeed,
	                " MB/s (average speed)"
	              )
	            ),
	            React.createElement(
	    ...
	    return React.createElement(
	      ...
	      this.state.displayInput ? React.createElement(NewSelection, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewSelection = React.createClass({
	  ...
	  addTag: function addTag() {
	    var newTag = { name: this.state.name, value: this.state.value };
	  ...
	  render: function render() {
	    ...
	    if (this.state.tags) {
	      this.state.tags.forEach(function (tag) {
	        ...
	        tags.push(React.createElement(
	          "div",
	          { className: "tag-query", key: tag.name },
	          " ",
	          string,
	          " "
	        ));
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          "span",
	          { onClick: this.addTag, className: "add-button" },
	          "add tag"
	        ),
	        React.createElement(
	          "span",
	          { onClick: this.createSelection,
